    ...
    return(
        ...
        <div>
            ...
            <div className='containerTextAboutUs'>
                <p className='textAboutUs'>We are a family-based small company passionate about delivering high quality and impressive results on everything we do. Our motivation is to be known not only for our services but for our dedication, professionalism and the great experience that we can (And will) Provide as well.<br/>If we go a little more personal, our biggest joy is to share special moments with our loved ones, to be there, create memories that we can later talk about and keep them forever in our souls. This was our main inspiration, we realized that as much as we love to share special moments, we also love creating them!, and we are more than positive that this is the greatest way to do so, and we would love it if you allow us to do so!.</p>
            </div>
        </div>
            <div>
                <h2 className='textSlogan'>“We elevate your experience to the next level” </h2>
            </div>
            <div>
